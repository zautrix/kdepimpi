 ...
 * @version $Id: knuminput.h,v 1.2 2010/01/27 21:55:05 zautrix Exp $
 */
...
public:
#ifdef QT_4_COMPAT
    KIntSpinBox *editor() { return this ;}
    int lineStep() { return singleStep();}
#endif
...
#ifdef QT_4_COMPAT
    KDoubleSpinBox *editor() { return this ;}
    //int lineStep() { return singleStep();}
#endif
