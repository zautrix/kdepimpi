...
template <class T>
#ifdef _WIN32_
TypeCombo<T>::TypeCombo( typename TypeCombo::List &list, QWidget *parent,
#else
TypeCombo<T>::TypeCombo( TypeCombo::List &list, QWidget *parent,
                      ...
                      const char *name )
  : KComboBox( parent),
//US my kde version has no KComboBox constructor witgh two parameters    
//US  : KComboBox( parent, name ),
    mTypeList( list )
{
}
...
template <class T>
#ifdef _WIN32_
void TypeCombo<T>::insertType( typename const TypeCombo::List &list, int type,
#else
...
template <class T>
#ifdef _WIN32_
void TypeCombo<T>::insertTypeList( typename const TypeCombo::List &list )
#else
